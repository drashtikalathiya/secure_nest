  ...
  return (
    <div className="fixed inset-0 z-50">
      <button
        ...
        onClick={onClose}
        aria-label="Close permission drawer"
      />

      <aside className="absolute right-0 top-0 flex h-full w-full max-w-[360px] flex-col border-l border-slate-800/80 bg-[#121f36] shadow-2xl">
        <div className="flex items-start justify-between border-b border-slate-800/80 px-5 py-4">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-400">
              Manage permissions for {member.name || member.email}
            </p>
          </div>
          <button
            type="button"
